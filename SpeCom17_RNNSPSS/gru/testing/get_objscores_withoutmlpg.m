function[mcd,bapd,f0rmse,vuvd,pmgc_mlpg,pbap_mlpg,pf0_mlpg,pvuv] = get_objscores_withoutmlpg(pcmp_deltas,ocmp_deltas,LOWERF0,UPPERF0,vo,vo_v,mgcdim,bapdim,outvec_mgc,outvec_bap,outvec_f0,vuvth)
...
pmgc_mlpg = pmgc_deltas(:,1:mgcdim);
...
pbap_mlpg = pbap_deltas(:,1:bapdim);
