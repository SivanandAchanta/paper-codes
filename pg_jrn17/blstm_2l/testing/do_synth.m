function[y_mlpg] = do_synth(pmgc_mlpg,pbap_mlpg,pf0,fs,prm,spsssynthdir,fname,mlpgstr,X2X,MGC2SP,FREQWARP,GAMMA,MGCORDER,lenfac,nfftby2)
...
y_mlpg = synth_st(pf0',psp,pap,fs,prm,spsssynthdir,fname,strcat(mlpgstr,'.wav'));
