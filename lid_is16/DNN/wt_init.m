...
switch wtinit_meth
    ...
    case 'lw'
        ...
        %arch_name = '13L100R462M_l25e-05alpha0.0001_b10.9_b20.995_bs1000_yi_1';
        
        arch_name = '13L500R500R500R462M_l25e-05_lr0.01_mf0.9_bs1000_yi_1';
        load(strcat(wtdir,'W_',arch_name,'.mat'))
        %sa(strcat(wtdir,'W_',arch_name,'.mat'))
    case 'yi'
