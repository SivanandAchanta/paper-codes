...
for j = 1:length(lang_list)
    ...
    for k = 1:length(gen_name_list)
        ...
        for li = 1:test_numbats
            ...
            [me,ol_mat,Y] = compute_error_singlefile(test_batchdata, test_batchtargets, test_clv, test_numbats, li, p_f_1_1,p_f_1_2,p_f_1_3,p_f_1_4,p_f_1_5,p_lf_1,p_lb_1,p_lf_2,p_lb_2,p_f_2_1,p_f_2_2,p_f_2_3,p_f_2_4,p_f_2_5,p_f_2_6,p_f_2_7,p_f_2_8,p_f_2_9,f,nl,cfn);
