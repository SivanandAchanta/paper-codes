...
expname = 'exp_hts_mgcmapf048k_Tamil';
expdir = strcat('../../',expname,'/');
datadir = strcat(expdir,'data/');
newexpname = 'exp_hts_mgcmapf048k_Tamil';
wtdir = strcat('../../wt/',newexpname,'/');

% testfiles
testwavpath = '../../voices/Tamil/data/test/acoustic_feats/feats_16k/wav/';
...
berp = [1 0.5 0.5 1 1 1 1]; % bernoulli prob of output layer is always 1
...
arch_name = strcat('2x1000R182L','_bs',num2str(train_batchsize),'_rho_eps_mf',num2str(rhoada),num2str(epsada),num2str(mf),'_withdropout');
