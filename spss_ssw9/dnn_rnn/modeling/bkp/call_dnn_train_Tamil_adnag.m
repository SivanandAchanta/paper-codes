...
mf_vec = [0.5]; % momentum factor
berp = [1 0.5 1 1 1 1 1]; % bernoulli prob of output layer is always 1
mncflag = 0;
mnc = 4;
...
for mfi = 1:length(mf_vec)
    ...
    arch_name = strcat('3x1000R182L','_bs',num2str(train_batchsize),'_rho_eps_mf',num2str(rhoada),num2str(epsada),num2str(mf),'_withdropout');
    nl = [din 1000 1000 1000 dout];
