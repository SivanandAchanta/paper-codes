...
if f0vuvp_flag
    ...
    arch_name_f0 = '347L500R100R4L_l25e-05alpha0.001_b10.9_b20.999_yi_gv0_lambda0.005_mvni_mvno_139';
...
for li = 1:train_numbats
    ...
    if f0vuvp_flag
        ...
        tic
        %         size(X)
        [ol] = fpav_cpu(X,W_f0,b_f0,nl_f0,f_f0,nh_f0,a_tanh,b_tanh,wtl_f0,btl_f0,sl);
        toc
        % % test set variables
        ...
        clear ol;
        mt_f0vuv = train_batchtargets(train_clv(li):train_clv(li+1)-1,outvec_f0);
